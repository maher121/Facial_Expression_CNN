...
if method==1
save info_googlenet\JAFFA\info_SVM  classifier C
end
if method == 2
save info_googlenet\CK\info_SVM  classifier C
end
...
PRTable = helperPrecisionRecall(C)
if method==1
save info_googlenet\JAFFA\info_tree treeMd C
end
if method == 2
save info_googlenet\CK\info_tree treeMd C
end
...
PRTable = helperPrecisionRecall(C)
if method==1
save info_googlenet\JAFFA\info_knn  knnMd C
end
if method == 2
save info_googlenet\CK\info_knn  knnMd C
end
disp("-------------------- End KNN ---------------")
